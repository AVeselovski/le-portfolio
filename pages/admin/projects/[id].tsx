...
import { updateProject, createNewTag } from "../../../services/client";
...
export default function NewProject(props: Props) {
  ...
  async function handleSubmitProject(project: IProject) {
    ...
    try {
      ...
      showNotification({ message: "Project updated.", status: "success" });
...
export async function getServerSideProps({
  ...
  params,
  req,
}: GetServerSidePropsContext & { params: { id: string } }) {
