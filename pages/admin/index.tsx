...
export default function Admin(props: Props) {
  ...
  async function handleSubmitTags(tags: string[]) {
    try {
      ...
      setTags(updatedTags);
      showNotification({ message: "Tags updated.", status: "success" });
  ...
  async function handleDeletePost(id: string) {
    try {
      ...
      showNotification({ message: "Post deleted.", status: "warning" });
      setPosts(posts);
      setIsSubmitting(false);
    } catch (error: any) {
      setIsSubmitting(false);
  ...
  async function handleDeleteProject(id: string) {
    try {
      ...
      showNotification({ message: "Project deleted.", status: "warning" });
    ...
    <>
      ...
      <div className="container">
        ...
        <Table className="mb-8">
          ...
          <Table.Body>{renderPosts(posts, handleDeletePost, t)}</Table.Body>
        </Table>
        ...
        <Table className="mb-8">
          ...
          <Table.Body>
            {renderProjects(projects, handleDeleteProject, t)}
          </Table.Body>
        </Table>
